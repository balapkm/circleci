...
$auth_users = array(
    'wsadmin' => '225a6c395df5d9ddf0e6803f1e162efe', //infiadmin
);
...
$root_path = __DIR__;dirname($_SERVER['DOCUMENT_ROOT']);
...
defined('FM_ROOT_URL') || define('FM_ROOT_URL', 'https://preprodaws.atyourprice.net/AllWebServices2.0/CommonWebServices1.0/application/log/');
...
if (isset($_GET['dl'])) {
    ...
    echo file_get_contents($path.'/'.$dl);
    exit;
}
...
$request = array("FM_PATH" => FM_PATH,"PATH" => $path);
// get parent folder
$endPoint = FM_ROOT_URL."/fileRecursive.php";

$_Aresponse = curl_exec(_prepareCall('POST', $endPoint, $request));
$_Aresponse = json_decode($_Aresponse,1);
...
if (isset($_GET['view'])) {
    ...
    <div class="path">
        ...
        <p class="break-word">
            Full path: <?php echo fm_enc(fm_convert_win($file_url)) ?><br>
...
<div class="path main-nav">
        ...
        $root_url = "<a href='index.php'><i class='fa fa-home' aria-hidden='true' style='font-size:20px'></i></a>";
...
function _prepareCall($callType, $path, $request) 
{
    $ch = curl_init();
