...
node {
    stage("checkout") {
        ...
        flywayrunner commandLineArgs: '', credentialsId: '29094ff4-b5ea-47ad-8491-6fdcd0756608', flywayCommand: 'migrate', installationName: 'Flyway', locations: '', url: 'jdbc:mysql://localhost:3306/test'
    }
