...
node {
    stage("checkout") {
        ...
        flywayrunner commandLineArgs: '', credentialsId: '29094ff4-b5ea-47ad-8491-6fdcd0756608', flywayCommand: 'migrate', installationName: 'testDb', locations: '/var/www/html/sql', url: 'jdbc:mysql://13.232.76.112:3306/test'
    }
